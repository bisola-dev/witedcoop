...
$allowTypes = array('jpg','png','jpeg');
 if (!in_array($fileType, $allowTypes)){
      ...
      $mysqlu = mysqli_query($conn, "INSERT INTO supot (fid, flame, fmsg, fdate, tid, tlame, natu) 
    	VALUES ($id1, '$fully', '$fileName', '$date_reg', 0, 'Admin', 2)"); 

    $mysqlum = mysqli_query($conn, "UPDATE memberz SET msg = $messi WHERE id = $id1");

      echo '<script type="text/javascript">
       alert("Image upload to the Admin successful.")
         </script>'; 
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Admin support page</h3>
...
<?php  $resultt = mysqli_query($conn, "SELECT * FROM supot WHERE (fid = $id1 OR tid = $id1) AND dele = 0");
