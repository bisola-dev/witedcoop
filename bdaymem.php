<?php require_once("cann.php");
  ...
  $memmem = mysqli_query($conn, "SELECT * FROM memberz WHERE dob ='$todayfull'");
...
<head>
    ...
    <body>
	  ...
	  <?php 
             ...
             $memmem = mysqli_query($conn, "SELECT * FROM memberz WHERE dele = 0 AND dob ='$todayfull' ORDER BY sname ASC");
