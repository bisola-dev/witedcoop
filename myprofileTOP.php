									...
									<div class="profile-view">
										<div class="profile-img-wrap">
											<div class="profile-img">
												<a href="#"><img alt="" src="memb/<?php echo $pix1;?>"></a>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														<h3 class="user-name m-t-0 mb-0"><?php echo $fully; ?></h3>
														<h6 class="text-muted"><?php echo $rank1; ?></h6>
														<small class="text-muted">Level : <?php echo $level1; ?></small>
														<div class="staff-id">Employee ID : <?php echo $staffid1; ?></div>
														<div class="small doj text-muted">Date Joined : <?php echo $djoin1; ?></div>
														<div class="staff-msg"><a class="btn btn-custom" data-target="#profile_info" data-toggle="modal" class="edit-icon" href="#">Edit profile</a></div>
													</div>
												</div>
												<div class="col-md-7">
													<ul class="personal-info">
														<li>
															...
															<div class="text"><a href="#"><?php echo $fon1;?></a></div>
														</li>
														<li>
															<div class="title">Email:</div>
															<div class="text"><a href="#"><?php echo $email1; ?></a></div>
														</li>
														<li>
															<div class="title">Birthday:</div>
															<div class="text"><?php echo $dob1; ?></div>
														</li>
														<li>
															<div class="title">Address:</div>
															<div class="text">23, Daodu street, Lagos</div>
														</li>
														<li>
								...
								<div class="col-md-6 d-flex">
									<div class="card profile-box flex-fill">
										<div class="card-body">
											...
											<ul class="personal-info">
												<li>
													<div class="title">Staff No.</div>
													<div class="text"><?php echo $staffid1; ?></div>
												</li>
												<li>
